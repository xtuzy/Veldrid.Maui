...
void main()
{
    FragColor = vec4(1.0f, 0.5f, 0.2f, 1.0f);
        ...
        public static (byte[], byte[]) GetShaderBytes(GraphicsBackend backend)
        {
            byte[] vertexBytes = backend == GraphicsBackend.Metal ? HelloTriangle_Vertex_MLSL : backend == GraphicsBackend.Direct3D11 ? HelloTriangle_Vertex_HLSL : backend == GraphicsBackend.OpenGLES ? HelloTriangle_Vertex_GLES : spirvVertexCode;
            byte[] fragmentBytes = backend == GraphicsBackend.Metal ? HelloTriangle_Fragment_MLSL : backend == GraphicsBackend.Direct3D11 ? HelloTriangle_Fragment_HLSL : backend == GraphicsBackend.OpenGLES ? HelloTriangle_Fragment_GLES : spirvFragmentCode;
